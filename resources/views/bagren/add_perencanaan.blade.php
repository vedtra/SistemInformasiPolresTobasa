...
@section('row1')
    <form class="form-horizontal form-material" role="form" method="POST" action="{{ url('bagren/perencanaan/save') }}">
        {{ csrf_field() }}
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <div class="table-responsive">
                        <table class="table ">
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6">
                                        <input id="divisi" value="4" type="text" class="form-control" name="divisi">
                                    </div>
                                </td>
                            </tr>
                                </div>
