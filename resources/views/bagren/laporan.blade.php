...
@section('row1')
    <div class="col-sm-12">
        <div class="white-box">
            <form class="form-horizontal form-material" role="form" method="POST" enctype="multipart/form-data" action="{{ url('/bagren/sv_lap') }}"">
                {{ csrf_field() }}
                    ...
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="" action="{{url('bagren/del_lap',$laporan->id_laporan)}}" method="post">
