...
<head>
    ...
    <link href="{{ asset('usium/bootstrap/dist/css/bootstrap.min.css') }}" rel="stylesheet">
    <!-- Menu CSS -->
    ...
    <!-- animation CSS -->
    <link href="{{ asset('usium/css/animate.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{ asset('usium/css/style.css') }}" rel="stylesheet">
    <!-- color CSS -->
    <link href="{{ asset('usium/css/colors/blue-dark.css') }}" id="theme" rel="stylesheet">
...
Halo
    ...
    <div id="wrapper">
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="{{url('/createskck') }}" class="waves-effect"><i class="fa fa-edit fa-fw" aria-hidden="true"></i><span class="hide-menu">Buat SKCK</span></a>
                    </li>
                    <li>
                        <a href="{{url('/skck') }}" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i><span class="hide-menu">Data skck</span></a>
                    </li>

                    <li>
                        <a href="{{url('/sium') }}" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i><span class="hide-menu">Data Pemohon</span></a>
                    </li>                    
                </ul>
                </div>
            </div>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2017 &copy; PA2-1617-D3TI01 </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
    ...
    <script src="{{ asset('usium/js/jquery.slimscroll.js') }}"></script>
    <!--Wave Effects -->
    ...
    <script src="{{ asset('usium/js/custom.min.js') }}"></script>
    <script src="{{ asset('usium/js/dashboard1.js')}}"></script>
