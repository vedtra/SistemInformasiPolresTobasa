...
@section('row1')
    <div class="col-sm-12">
        <div class="white-box">
            <form class="form-horizontal form-material" role="form" method="POST" enctype="multipart/form-data" action="{{ url('/sium/sv_lap') }}"">
                {{ csrf_field() }}
                    ...
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="" action="{{url('sium/del_lap',$laporan->id_laporan)}}" method="post">
